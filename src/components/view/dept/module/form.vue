<template>
  <div class="w_table_form">
    <el-dialog :title="isAdd ? '新增部门': '编辑部门'" :visible.sync="dialogVisible" width="500px" center :append-to-body="true">
      <el-form :model="form" ref="form" size="small" label-width="80px">
        ...
        <el-form-item v-if="form.pid !== 0" label="状态" prop="enabled">
          <el-radio v-for="item in dicts" v-model="form.enabled" :label="item.value" :key="item.id+'dt'">{{ item.label }}</el-radio>
        </el-form-item>
